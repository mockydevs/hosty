...
/**
 * Dashboard v0: live service status cards + CPU / RAM / disk gauges.
 * Stats poll every 5s, services every 10s.
 */
    ...
    <Card>
      ...
      <CardContent className="flex items-center justify-between">
        <p className="text-xs text-muted-foreground">
          {service.available ? `${service.sub_state} · ${service.enabled}` : "—"}
        </p>
        {service.available && (
          <Button
            variant="ghost"
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Sites, databases, DNS and backups arrive in upcoming phases. This dashboard will grow
            recent-activity and alerts as those land.
          </CardDescription>
        </CardHeader>
      </Card>
    </div>
